...
Covering points with unit discs or squares is APX-hard
\cite{marx07}.

Covering points with squares is W[1]-hard \cite{marx05}.

If we allow $\delta$-expansion, the Set Cover with rectangles
remains APX-complete (for~$\delta = 1/2$),
...
It can be found in Har-Peled-Lee paper (TODO: ?).
