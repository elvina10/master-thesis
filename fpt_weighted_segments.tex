...
by $\mathcal{O}(k^4 + k^2(2+\frac{2}{\delta})^2k)$.
...
than size of $\sol$ (because some segments $s$ can map
...
$(|\sets| + |\points|)^{\mathcal{O}(1)}\mathcal{O}((2 + \frac{2}{\delta})^k) + \mathcal{O}((k^2 + k(2 + \frac{2}{\delta})^k)^k)$.
\end{proof}
