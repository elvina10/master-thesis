...
\chapter{APX-completeness Geometric Set Cover}
\input{apxcomplete.tex}
\chapter{FPT for Geometric Set Cover for segments with $\delta$-extenstions}
\input{segments.tex}
\input{fpt_weighted_segments.tex}
\chapter{W[1]-completeness for weighted segments in 3 directions}
\input{w1_completeness.tex}
