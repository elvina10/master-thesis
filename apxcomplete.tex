...
points $C\_clause_i - \{a\}$ can be covered with $P\_true_a^i \subset P\_clause_i$,
such that $|P\_true_a^i| = 11$.
\end{lemma}
...
For any $1 \le i \le n$,
points $C\_clause_i$ can be covered with $P\_false^i \subset P\_clause_i$,
such that $|P\_false^i| = 12$.
\end{lemma}
...
\begin{proof}
We can just check every segment. Most of them are not colinear.
The only colinear segments are gadget segments that are sufficiently far
