...
We will find kernel where every segment doesn't have more than $3k$
points on it and every segment has at least 2 points on them.
Then we will have at most $3k^2$ points (otherwise there is no solution).
...
segment in this direction having at least $k$ points on it.
\begin{enumerate}
\item Choose 
\end{enumerate}
