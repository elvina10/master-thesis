...
\draw[environment,ultra thick] (\xbeg,\y1) -- (\x1,\y1) node[pos=0.15, above] {$input_x$};
\draw[environment,ultra thick] (\xbeg,\y5) -- (\x1,\y5) node[pos=0.15, above] {$input_y$};
...
\draw[choose_true2, ultra thick] (\x3,\y3) -- (\xend,\y3);
