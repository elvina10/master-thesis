...
\begin{proof}
1. Solution has to have $2k^2$ gaps for points covered in DIAG
\begin{itemize}
\item I guess I don't need that if I use 2.
\end{itemize}

2. Solution has to have at most one DIAG segment in every square
\begin{itemize}
\item One h and v points are covered with DIAG for i,j
