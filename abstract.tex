\begin{abstract}
	...
	and parameterized algorithms for a variant of $\SetCover$ problem,
	...
	We also consider problem relaxed with $\delta$-extension, where we
	...
	even if we restrict segments to be axis-parallel segments
