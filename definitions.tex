...
We also consider a weighted parameterized setting, which is a combination
of the two above settings. We already argued in the introduction
...
Another idea presented here, which can be utilized only when talking
about the problems with geometric objects,
is $\delta$-extension.
