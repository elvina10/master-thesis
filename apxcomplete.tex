...
\begin{align}
	...
	& \begin{cases}
	\phi(x_i) = majority(X_i) & \text{if}\ \xTrueSegment \in \sol \land \xFalseSegment \in \sol \\
	\phi(x_i) = true & \text{if}\ \xTrueSegment \in \sol \\
	\phi(x_i) = false & \text{if}\ \xFalseSegment \in \sol \\
