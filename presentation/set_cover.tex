...
segments, then these segents after $\delta$-extension
cover all points from the original set of points $S$.
\end{frame}

\begin{frame}
\frametitle{Parametrization of \textsc{Weighted Segment Set cover}}
...
This result is particalarily interesting, because unweighted problem 
