...
We denote set of points marked with black circle as $P\_variable_i$
...
We denote set of these points as $P\_clause_i$.
...
\paragraph{Proof.}
There is independent set of size 3 -- $d_i, f_i, c_i$, therefore it can
...
\end{lemma}
\paragraph{Proof.}
There is independent set of size 2 -- $a_i, e_i$, therefore it can
...
There is independent set of 12 points in $P\_clause_i$ -- 
...
$X \cup Z \cup Z \subseteq P\_clause_i - \{x_{i, 0}, y_{i, 0}, z_{i, 0}\}$.
...
Therefore $P\_clause_i$ must be covered with at least 3 + 4 + 4 = 11 segments.
