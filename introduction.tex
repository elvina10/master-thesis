...
(even if we relax the problem with  $\frac{1}{2}$-extensions) is APX-hard
...
\begin{restatable}{tw}{fptWeightedSegment}[FPT for weighted segment cover with $\delta$-extensions]{
