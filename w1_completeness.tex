...
which was introduced in \cite{platypus_book}.
...
that for every pair row, column, the pair of numbers assigned
to the row and column belongs to allowed set
for this row and column intersection.
The next theorem is describing complexity of the problem,
it is W[1]-hard parametrized by size of the grid.
...
This theorem is proved in \cite{platypus_book}, page 490.
