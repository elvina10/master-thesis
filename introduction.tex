...
and W[2]-complete with the natural parametrization,
...
presenting a new FPT result for this problem with the natural parametrization.
...
but they trivially follow from stronger results shown in other cells of the table.}
