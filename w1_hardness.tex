...
(which we reduced to the $\WeightedSegmentSetCover$).
...
in time $g(l)\cdot n^{o(l)}$ by constructing an instance of the
...
of the constructed instance of $\WeightedSegmentSetCover$.
Then Lemma \ref{grid_tiling_exists} proves that if
there is a solution to the $\WeightedSegmentSetCover$ instance with bounded weight,
