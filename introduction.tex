...
Geometric Set Cover with unit squares is first proven to be W[1]-hard 
Theorem 5 in \cite{marx05}, later work \cite{voronoi}
shows that there is an algorithm running in time $O(n^{\sqrt{k}})$
